...
/**
 * Dispatched every time a customer proves their address by confirming a login link — on the first
 ...
 * the buyer logs in — instead of staying orphaned forever because the one moment that could have
 * claimed them has passed.
 */
final class CustomerAuthenticatedEvent extends Event
{
