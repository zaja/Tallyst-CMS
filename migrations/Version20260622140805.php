 ...
 */
final class Version20260622140805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD nickname VARCHAR(191) DEFAULT NULL, ADD name VARCHAR(191) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP nickname, DROP name');
    }
}
